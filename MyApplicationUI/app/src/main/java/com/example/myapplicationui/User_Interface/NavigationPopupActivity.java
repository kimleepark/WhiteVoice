...
<<<<<<< HEAD
        TTSClass.Init(getApplication(), "현재 입력된, 목적지는," + getData.getStringExtra("getVoiceString") + " ,이며, 가장 근접하게, 검색된, 목적지는, " + getData.getStringExtra("destinationmap")+ ", 입니다.                                                   총 " + getData.getIntExtra("fullDistance",1) + "미터,                                            떨어져 있으며, 약,  " + hour + "시간, " + min + "분, 소요될 예정입니다.                                        ");
=======
...
>>>>>>> 2395562b343b941a21dd00a32de14a4b907bcb33
